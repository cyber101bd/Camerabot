...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    keyboard = [
        [
            ...
            InlineKeyboardButton("Developer info", callback_data="c"),
        ]
    ]
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "a":
        ...
        await query.message.reply_text(About Developer:
        Hi i am RoNi
Passionate developer from Bangladesh.
Building Telegram bots, web apps, and smart digital solutions with modern design and smooth experience.)
